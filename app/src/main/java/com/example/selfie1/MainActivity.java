...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selfieList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Intent intent = new Intent(MainActivity.this, com.example.selfie1.DetailActivity.class);
    ...
    private void createSelfieAlarm() {
        Intent intent = new Intent(this, com.example.selfie1.SelfieNotificationReceiver.class);
